...
<template>
  <div class="fixed top-0 left-0 right-0 z-50 bg-[#181818] backdrop-blur-[50px]">
    <header class="flex justify-between items-center px-5 py-2 border-b border-slate-600">
